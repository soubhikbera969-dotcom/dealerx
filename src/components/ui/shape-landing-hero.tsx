      ...
      >
        <div
          className={cn(
            ...
            "shadow-[0_8px_32px_0_hsl(var(--foreground)/0.05)]",
            "after:absolute after:inset-0 after:rounded-full",
            "after:bg-[radial-gradient(circle_at_50%_50%,hsl(var(--foreground)/0.15),transparent_70%)]",
          )}
        />
      </motion.div>
    </motion.div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-6 md:mb-8 tracking-tight leading-tight">
              ...
              <br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-foreground/90 to-primary">
                {title2}
              </span>
            </h1>
          </motion.div>
